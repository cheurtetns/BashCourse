...
#
# To substitute a string: s/OLD_PATTERN/NEW_PATTERN/OPTIONS
#
# To modify all strings, put the OPTIONS to 'g'
#
# EXERCICE: - Substitute all 'unix' string in file.txt into 'linux'
#
# I AM NOT DONE
# Do not modify this line
file="./solutions/sed/file.txt"
